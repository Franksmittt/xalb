...
export default function Header() {
  ...
  const navigation = [
    ...
    { name: 'Our Process', href: '/process' },
    {
      ...
      href: '/solutions',
      submenu: [
        { name: 'Retail & Point of Sale', href: '/solutions/retail' },
        { name: 'Corporate Identity', href: '/solutions/corporate' },
        { name: 'Industrial & Safety', href: '/solutions/industrial' },
        { name: 'Vehicle & Fleet', href: '/solutions/vehicle' },
      ],
    },
