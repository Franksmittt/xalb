      ...
      <section className="relative z-10 px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-[0.4em] text-accent mb-4">Print Services</p>
            ...
            <p className="text-lg text-ink-muted max-w-3xl mx-auto mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <span className="px-4 py-2 rounded-full bg-[#AEDD33]/10 text-accent border border-[#AEDD33]/30">
                Lead Time: 10 Days
              </span>
          ...
          <div className="mb-16">
            <div className="rounded-3xl border border-[var(--line)] bg-surface backdrop-blur-xl p-8 md:p-12">
          ...
          {/* How It Works */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-ink mb-8 text-center">How Lithographic Printing Works</h2>
            <div className="grid sm:grid-cols-2 gap-6 sm:gap-8">
              <div className="rounded-3xl border border-[var(--line)] bg-surface backdrop-blur-xl p-8">
                <h3 className="text-xl font-bold text-ink mb-4">The Offset Process</h3>
                <ol className="space-y-4 text-ink-muted">
                  ...
                  <li className="flex gap-3">
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#AEDD33]/20 border border-[#AEDD33] text-accent flex items-center justify-center text-sm font-bold">3</span>
                    <span>The inked image transfers (offsets) from the plate to a rubber blanket cylinder.</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#AEDD33]/20 border border-[#AEDD33] text-accent flex items-center justify-center text-sm font-bold">4</span>
                    <span>The blanket then transfers the image onto the paper as it passes through the press.</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#AEDD33]/20 border border-[#AEDD33] text-accent flex items-center justify-center text-sm font-bold">5</span>
                    <span>Multiple colors are printed in sequence, with precise registration between color passes.</span>
                  </li>
                </ol>
              </div>
              <div className="rounded-3xl border border-[var(--line)] bg-surface backdrop-blur-xl p-8">
                <h3 className="text-xl font-bold text-ink mb-4">Why Choose Litho?</h3>
          ...
          {/* Advantages Grid */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-ink mb-8 text-center">Key Advantages</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {advantages.map((advantage) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-ink mb-2">{advantage.title}</h3>
          ...
          {/* Applications */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-ink mb-8 text-center">Common Applications</h2>
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
              {applications.map((category) => (
                <div
                  key={category.category}
                  className="rounded-2xl border border-[var(--line)] bg-surface backdrop-blur-xl p-6"
                >
                  <h3 className="text-xl font-bold text-ink mb-4">{category.category}</h3>
          ...
          {/* Process Timeline */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-ink mb-8 text-center">Our 10-Day Process</h2>
            <div className="space-y-6">
              {processSteps.map((step) => (
                <div
                  key={step.step}
                  className="rounded-3xl border border-[var(--line)] bg-surface backdrop-blur-xl p-6 md:p-8"
                >
          ...
          <div className="mb-16">
            <div className="rounded-3xl border border-[var(--line)] bg-surface backdrop-blur-xl p-8 md:p-12">
              <h2 className="text-3xl font-bold text-ink mb-8">Technical Specifications</h2>
              <div className="grid sm:grid-cols-2 gap-6 sm:gap-8">
                <div>
                  <h3 className="text-xl font-bold text-ink mb-4">Capabilities</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold text-ink mb-4">Finishing Options</h3>
                  <ul className="space-y-3 text-ink-muted">
                    <li className="flex items-start gap-3">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-[#FF1744] flex-shrink-0" />
          ...
          <div className="rounded-3xl border border-[#AEDD33]/30 bg-gradient-to-br from-[#AEDD33]/5 to-[#1E8F40]/5 p-8 md:p-12 text-center">
            <h3 className="text-3xl font-bold text-ink mb-4">Ready to Start Your Litho Project?</h3>
