  ...
  return (
    <main className="relative min-h-screen bg-gradient-to-br from-[#03050d] via-[#080d1c] to-[#140621] text-white flex items-center justify-center px-4">
      ...
      <div className="relative z-10 text-center max-w-2xl">
        <h1 className="text-6xl md:text-8xl font-extrabold mb-6 bg-gradient-to-r from-[#00F5FF] via-[#2D9CFF] to-[#FF1744] bg-clip-text text-transparent">
          404
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center rounded-full bg-[#00F5FF] px-8 py-4 text-base font-semibold text-[#010308] shadow-[0_15px_35px_rgba(0,245,255,0.4)] hover:bg-[#00c3ff] transition-colors"
          >
            Go to Homepage
          </Link>
          <Link
