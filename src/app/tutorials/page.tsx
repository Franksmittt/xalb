      ...
      <section className="relative z-10 px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-[0.4em] text-accent mb-4">Expert Guides</p>
          ...
          {tutorials[0] && tutorials[0].featured && (
            <div className="mb-16">
              <p className="text-xs uppercase tracking-[0.3em] text-accent mb-4">Featured Tutorial</p>
              <Link href={tutorials[0].href}>
                <motion.div
                  whileHover={{ scale: 1.02 }}
                  className="relative overflow-hidden rounded-3xl border border-accent/30 bg-gradient-to-br from-[#AEDD33]/10 to-[#1E8F40]/10 p-8 md:p-12 "
                >
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                      ...
                      <h2 className="text-3xl md:text-4xl font-bold text-ink mb-4">{tutorials[0].title}</h2>
                      <p className="text-ink-muted text-lg mb-6">{tutorials[0].description}</p>
          ...
          {/* All Tutorials Grid */}
          <div>
            <h2 className="text-2xl font-bold text-ink mb-6">All Tutorials</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {tutorials.map((tutorial) => (
                <Link key={tutorial.href} href={tutorial.href}>
                  <motion.div
                    whileHover={{ y: -4 }}
                    className="group relative overflow-hidden rounded-2xl border border-[var(--line)] bg-surface backdrop-blur-xl hover:border-accent/50 transition-all duration-300"
                  >
                    <div className="aspect-[4/3] relative overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4">
                        <span className="inline-block px-3 py-1 text-xs font-semibold rounded-full bg-[#AEDD33]/20 text-accent">
                          {tutorial.category}
                        </span>
                      </div>
                    </div>
                    <div className="p-6">
                      ...
                      <p className="text-ink-muted text-sm mb-4 line-clamp-2">{tutorial.description}</p>
          ...
          {/* CTA Section */}
          <div className="mt-16 rounded-3xl border border-accent/30 bg-gradient-to-br from-[#AEDD33]/5 to-[#1E8F40]/5 p-8 md:p-12 text-center">
            <h3 className="text-2xl md:text-3xl font-bold text-ink mb-4">Need Professional Help?</h3>
