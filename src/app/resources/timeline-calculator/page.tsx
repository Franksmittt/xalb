      ...
      <section className="relative z-10 px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-xs uppercase tracking-[0.4em] text-accent mb-4">Planning Tool</p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="rounded-3xl border border-[var(--line)] bg-surface backdrop-blur-xl p-8">
                <h2 className="text-xl font-bold text-ink mb-6">Project Details</h2>
                
                <div className="space-y-6">
                  <div>
                    <label className="block text-sm font-semibold text-ink-muted mb-2">Project Type</label>
                    <select
                      value={projectType}
                      onChange={(e) => setProjectType(e.target.value)}
                      className="w-full px-4 py-3 rounded-lg bg-surface border border-[var(--line)] text-ink focus:border-[#AEDD33] focus:outline-none"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g., 10"
                      className="w-full px-4 py-3 rounded-lg bg-surface border border-[var(--line)] text-ink placeholder-slate-500 focus:border-[#AEDD33] focus:outline-none"
                    />
                  </div>

                  <div>
                    <label className="block text-sm font-semibold text-ink-muted mb-2">Complexity</label>
                    <select
                      value={complexity}
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-ink-muted mb-2">Material Availability</label>
                    <select
                      value={material}
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-ink-muted mb-2">Site Access</label>
                    <select
                      value={siteAccess}
            ...
            <div>
              <div className="rounded-3xl border border-[#AEDD33]/30 bg-gradient-to-br from-[#AEDD33]/5 to-[#1E8F40]/5 p-8 sticky top-8">
                <h2 className="text-xl font-bold text-ink mb-6">Estimated Timeline</h2>
                {timeline ? (
                  <div>
                    <div className="text-6xl font-extrabold text-ink mb-2">{timeline}</div>
                    <div className="text-xl text-ink-muted mb-6">Business Days</div>
                    ...
                    <div className="mt-6 pt-6 border-t border-[var(--line)]">
                      ...
                      <Link
                        href="/contact"
                        className="block w-full text-center rounded-full bg-[#AEDD33] px-6 py-3 text-sm font-semibold text-ink-inverse "
                      >
                        Get Accurate Quote
                      </Link>
                    </div>
                  ...
                  <div className="text-center py-12">
                    <p className="text-ink-muted">Fill in the project details to see your estimated timeline.</p>
                  </div>
                )}
              </div>
            </div>
