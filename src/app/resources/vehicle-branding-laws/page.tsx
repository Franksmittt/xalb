      ...
      <section className="relative z-10 px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-xs uppercase tracking-[0.4em] text-accent mb-4">Fleet Guide</p>
          ...
          <div className="mt-12 rounded-3xl border border-[#AEDD33]/30 bg-gradient-to-br from-[#AEDD33]/5 to-[#1E8F40]/5 p-8 text-center">
            <h3 className="text-2xl font-bold text-ink mb-3">Need Fleet Branding Support?</h3>
